...
public class Assignment5 {
	    public static void main(String[] args) {
	        ...
	        highestGrossingMovies.add("Baaubali");
	        highestGrossingMovies.add("RRR");
	        highestGrossingMovies.add("Chaava");
	        highestGrossingMovies.add("KGF");
	        highestGrossingMovies.add("Dhangal");
